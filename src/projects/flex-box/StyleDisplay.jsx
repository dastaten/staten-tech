...
export default function StyleDisplay({ currentStyles, numberOfBoxes, handleSelectChange }) {
  ...
  return (
    <div className='flex flex-col w-full gap-3 md:flex-row'>
      <div className='flex border-2 rounded-md border-sky-700 min-h-[5vh] w-full md:w-fit min-w-[130px] text-sky-200 justify-center items-center text-lg lg:text-xl font-bold pt-1 px-3'>
        <span>
          Boxes:
          <select
      ...
      <div className='flex border-2 rounded-md border-sky-700 min-h-[5vh] grow text-sky-200 justify-center items-center text-lg lg:text-xl font-bold pt-1'>
        {currentStyles.includes('flex') ? (
          <div className='flex flex-wrap items-center justify-center gap-2'>
            ...
            <span className='text-center text-sky-300'>{currentStyles.join(' ')}</span>
            <div>
              <img
                src={copy}
                alt='copy'
