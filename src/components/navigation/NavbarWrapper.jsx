export default function NavbarWrapper({ children, error, confirmEmail, pageTitle }) {
  ...
  return (
    <nav className='flex items-center justify-between pt-5 pb-4 bg-dark px-7 text-alt min-h-[72px] max-h-[88px] h-[7vh] md:h-[8vh] lg:h-[9vh] border-b-2 border-b-[#2f415c]'>
