...
export default function Skills() {
  ...
  return (
    <Section>
      ...
      <div className={`lg:text-lg flex flex-col items-center justify-center w-full max-w-[665px]  mx-auto gap-5 transition-opacity duration-300 ${isVisible ? ' opacity-100' : 'opacity-0'}`}>
