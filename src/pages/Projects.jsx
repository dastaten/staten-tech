    ...
    <Section>
      <div className={`flex flex-col items-center justify-center w-full transition-opacity duration-500 ${isVisible ? ' opacity-100' : 'opacity-0'}`}>
        <div className='flex flex-col items-center gap-5 max-w-[665px] lg:text-lg h-fit p-5 rounded-xl bg-slate-800 border-[1px] border-default'>
          <Link className='mt-3 mb-0 text-2xl font-bold md:text-3xl text-alt' to='/flexbox' target='_blank'><span>Flexbox Playground</span></Link>
          <Link to='/flexbox' target='_blank'><img src={ProjectFlexBoxPic} className='border-[1px] rounded-md border-default my-0 w-[400px] sm:w-[450px] md:w-[500px]' alt='Flexbox Playground' /></Link>
          ...
          <Link className='px-6 py-2 pt-3 mb-2 text-lg font-bold transition-all duration-300 rounded-full w-fit text-dark bg-alt hover:cursor-pointer hover:bg-[#5991ff] hover:text-[#1a1f2b]' to='/flexbox' target='_blank'><span className='flex justify-center'>View Project</span></Link>
        </div>
      </div>
    </Section>
  );
