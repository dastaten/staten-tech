    ...
    <Section>
      <div className={`py-10 flex flex-col items-center justify-center w-full transition-opacity duration-300 ${isVisible ? ' opacity-100' : 'opacity-0'}`}>
        <form
          ...
          onSubmit={sendEmail}>
          <p className='text-sm rounded-m md:text-base lg:text-lg'>
          ...
          <label htmlFor='from_name' className='text-lg font-bold lg:text-xl'>Name</label>
          ...
          <label htmlFor='from_email' className='text-lg font-bold lg:text-xl'>Email</label>
          ...
          <label htmlFor='message' className='text-lg font-bold lg:text-xl'>Message</label>
