  ...
  return (
    <Section>
      <div className={`flex flex-col items-center justify-center w-full h-full gap-3 p-5 rounded-xl bg-slate-800 max-w-[800px] lg:text-lg border-[1px] border-default transition-opacity duration-500 ${isVisible ? ' opacity-100' : 'opacity-0'}`}>
        ...
        <h2 className='mb-2 text-xl font-bold text-center md:text-2xl text-h2'>Revamped City of Baytown Site (3CMA Savvy Award Winner)</h2>
        ...
        <h2 className='mb-2 text-xl font-bold text-center md:text-2xl text-h2'>Rekindled Passion for Web Development</h2>
        ...
        <h2 className='mb-2 text-xl font-bold text-center md:text-2xl text-h2'>Excited to Collaborate</h2>
