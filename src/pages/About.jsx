...
export default function About() {
  ...
  return (
    <Section>
      <div className={`flex flex-col items-center justify-center w-full h-full gap-3 p-5 rounded-xl bg-slate-800 max-w-[800px] mx-auto my-10 lg:text-lg border-[1px] border-default transition-opacity duration-300 ${isVisible ? ' opacity-100' : 'opacity-0'}`}>
        <h2 className='mt-3 mb-2 text-xl font-bold md:text-2xl text-alt'>Over 20 Years of IT Experience – Passionate Web Developer</h2>
        ...
        <h2 className='mb-2 text-xl font-bold md:text-2xl text-alt'>Revamped City of Baytown Website (3CMA Savvy Award Winner)</h2>
        ...
        <h2 className='mb-2 text-xl font-bold md:text-2xl text-alt'>Rekindled Passion for Web Development</h2>
        ...
        <h2 className='mb-2 text-xl font-bold md:text-2xl text-alt'>Excited to Collaborate</h2>
